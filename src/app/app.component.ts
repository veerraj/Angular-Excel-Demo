...
export class AppComponent {
  ...
  generateExcel() {
    ...
    let  newArray = ['deviceId','location','customerName','user','odometerStart','odometerStartDateGMTMillis',
           'odometerEnd','odometerEndDateGMTMillis','realDistance','purpose','staff','tracking']
